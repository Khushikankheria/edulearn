...
//           DBMS stands for Database Management System. It is a software system that provides an interface
//           for users to interact with a database, ensuring that data is stored, organized, and managed efficiently.
//         </p>
...
//         <ul className="list">
//           <li><strong>Database Engine:</strong> Responsible for data storage, manipulation, and retrieval.</li>
//           <li><strong>Database Schema:</strong> Defines the structure of the database.</li>
//           <li><strong>Query Processor:</strong> Interprets and executes database queries.</li>
//           <li><strong>Transaction Manager:</strong> Ensures that transactions are processed reliably.</li>
//         </ul>
//       </div>
//     ),
//     "SQL Basics": (
  ...
  const content = {
    "Introduction to DBMS": (
      <div className="content">
        ...
        <p className="text">DBMS stands for Database Management System. It is a software system that provides an interface for users to interact with a database, ensuring that data is stored, organized, and managed efficiently. A DBMS allows for operations like data retrieval, insertion, deletion, and updating while maintaining consistency, security, and integrity.</p>
        <h2 className="heading" style={{ color: '#1a1a1a', borderBottom: '3px solid #333' }}>
          Key Components of a DBMS:
        </h2>
        <ul className="list">
        ...
        <p className="text">
          DBMS's can be categorized based on their data models:
        </p>
        <ul className="list">
          <li><strong>Hierarchical DBMS:</strong> Data is organized in a tree-like structure, where each record has a parent-child relationship.</li>
          <li><strong>Network DBMS:</strong> More complex than hierarchical, allowing many-to-many relationships between records.</li>
    ...
    "Data Models": (
      <div className="content">
        ...
        <h2 className="heading">Data Models in DBMS</h2>
        <p className="text">A data model defines the logical structure of a database and how data is stored,
          organized, and manipulated. Common types include:
        </p>
        <ul className="list">
          <li><b>Hierarchical Model:</b> Data is organized in a tree-like structure.</li>
...
VALUES (1, 'Alice', 20, 'A');`}
    ...
    "SQL Basics": (
      <div className="content">
        ...
        <h2 className="heading">SQL Basics</h2>
        <p className="text">SQL (Structured Query Language) is a standard language used for managing and manipulating relational databases. It allows users to query, insert, update, and delete data in a database. The key components of SQL are:</p>
        <h2 className="heading">Data Manipulation Language (DML):</h2>
        <ul className="list">
          <li><b>SELECT:</b> Retrieves data from a table.</li>
          <li><b>INSERT:</b> Adds new records into a table.</li>
          <li><b>UPDATE:</b> Modifies existing records in a table.</li>
        ...
        <h2 className="heading">Example SQL Queries:</h2>
        <div className="snippet-container">
          <SyntaxHighlighter language="sql" style={coy}>
            {`-- Retrieve all data from the Students table
SELECT * FROM Students;
...
WHERE ID = 2;`}
        ...
        <h2 className="heading">Additional SQL Clauses:</h2>
        <p className="text">SQL also provides several important clauses to manipulate and filter data more efficiently:</p>
        <ul className="list">
          <li><b>WHERE:</b> Used to specify conditions for filtering records.</li>
          <li><b>ORDER BY:</b> Sorts the result set by one or more columns.</li>
          <li><b>GROUP BY:</b> Groups rows that have the same values into summary rows.</li>
...
HAVING COUNT(*) > 1;`}
    ...
    "Normalization": (
      <div className="content">
        ...
        <h2 className="heading">Normalization in DBMS</h2>
        <p className="text">Normalization is the process of organizing data to reduce redundancy and improve
          efficiency. It involves dividing a database into smaller tables and defining relationships
          between them.
        </p>
        <h2 className="heading">Normal Forms:</h2>
        <ul className="list">
          <li><b>1NF:</b> Removes duplicate columns and ensures each column contains atomic values.</li>
          <li><b>2NF:</b> Ensures 1NF and removes partial dependencies.</li>
          <li><b>3NF:</b> Ensures 2NF and removes transitive dependencies.</li>
    ...
    "ER Model": (
      <div className="content">
        ...
        <h2 className="heading">Entity-Relationship (ER) Model</h2>
        <p className="text">The ER Model is a high-level conceptual data model used to represent the structure of a database. It defines the data elements and their relationships using a set of symbols. The ER model helps in designing the logical structure of databases in a way that is understandable to both developers and users.</p>
        <h2 className="heading">Key Components of the ER Model:</h2>
        <ul className="list">
          <li><b>Entities:</b> Represent real-world objects or concepts. Examples: <code>Student</code>, <code>Course</code>, <code>Employee</code>.</li>
          <li><b>Attributes:</b> Describe properties of entities. For example, a <code>Student</code> entity might have attributes like <code>Name</code>, <code>Age</code>, <code>ID</code>.</li>
          <li><b>Relationships:</b> Define associations between two or more entities. For example, a <code>Student</code> "Enrolls" in a <code>Course</code>.</li>
        ...
        <h2 className="heading">Types of Relationships:</h2>
        <ul className="list">
          <li><b>One-to-One:</b> One instance of an entity is related to one instance of another entity. For example, each <code>Student</code> has one <code>StudentID</code>.</li>
          <li><b>One-to-Many:</b> One instance of an entity is related to multiple instances of another entity. For example, a <code>Teacher</code> teaches multiple <code>Courses</code>.</li>
          <li><b>Many-to-Many:</b> Multiple instances of an entity are related to multiple instances of another entity. For example, <code>Students</code> can enroll in multiple <code>Courses</code>, and each <code>Course</code> can have multiple <code>Students</code>.</li>
        </ul>
        <h3><strong>Example ER Diagram:</strong></h3>
        <p className="text">
          Imagine a simple scenario where we have two entities: <code>Students</code> and <code>Courses</code>. The <code>Student</code> entity has attributes like <code>StudentID</code>, <code>Name</code>, <code>Age</code>. The <code>Course</code> entity has attributes like <code>CourseID</code>, <code>CourseName</code>. The relationship between these entities is "Enrolls", indicating that a student can enroll in multiple courses.
        </p>
        <p className="text">Below is a textual representation of the ER diagram:</p>
        <ul className="list">
          <li><b>Entities:</b>
            <ul>
              <li><code>Student</code> (StudentID, Name, Age)</li>
        ...
        <h3>ER Diagram Representation:</h3>
        <p className="text">A graphical ER diagram would show the <code>Student</code> and <code>Course</code> entities as rectangles, the attributes as ovals, and the relationship "Enrolls" as a diamond connecting the two entities.</p>
      </div>
    ),
    "Transactions": (
      <div className="content">
        ...
        <h2 className="heading">Transactions in DBMS</h2>
        <p className="text">A transaction is a sequence of operations performed as a single logical unit of work. Key
          properties of transactions (ACID) include:
        </p>
        <ul className="list">
          <li><b>Atomicity:</b> Ensures all operations are completed or none are.</li>
